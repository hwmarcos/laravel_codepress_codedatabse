...
class CategoryRepositoryTest extends AbstractTestCase
{
    ...
    public function test_can_have_a_model()
    {
    ...
    public function test_can_create_categories()
    {
        ...
        $this->assertEquals('desc 4', $result->description);
    ...
    public function test_can_update_categories()
    {
        ...
        $this->assertEquals('desc Atualizada', $result->description);
    ...
    public function test_can_findby_categories_with_columns()
    {
        ...
        $result = $this->repository->findby('name', 'Category 10', ['name']);
        $this->assertCount(0, $result);
    }
